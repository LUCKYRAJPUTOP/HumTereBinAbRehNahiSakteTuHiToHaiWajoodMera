...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/+A6hFLoAkshs5OWJl'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/LUCKYRAJPUTOP/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/LUCKYRAJPUTOP/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/+A6hFLoAkshs5OWJl'),     
        ],
        [
            InlineKeyboardButton("🎞 Developer ", url='https://t.me/ItzMeAnshulRajput'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://github.com/LUCKYRAJPUTOP/VCPlayerBot>VCPlayerBot.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
